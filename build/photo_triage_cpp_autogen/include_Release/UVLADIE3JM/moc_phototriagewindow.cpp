...
template <> constexpr inline auto PhotoTriageWindow::qt_create_metaobjectdata<qt_meta_tag_ZN17PhotoTriageWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'goToPreviousImage'
        QtMocHelpers::SlotData<void()>(11, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onFileListSelectionChanged'
...
void PhotoTriageWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->goToNextImage(); break;
        case 6: _t->goToPreviousImage(); break;
        case 7: _t->onFileListSelectionChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
